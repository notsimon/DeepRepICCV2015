...
class LogisticRegression(object):
    def __init__(self, input, n_in, n_out):
        ...
        self.p_y_given_x_printed = theano.printing.Print("p_y_given_x = ")(
            self.p_y_given_x
        )
        ...
        # symbolic form
        self.y_pred = T.argmax(
            self.p_y_given_x, axis=1
        )  #  TODO - need to return this if something wrong
...
class HiddenLayer(object):
    def __init__(self, rng, input, n_in, n_out, W=None, b=None, activation=T.tanh):
        ...
        self.output = (
            lin_output if activation is None else T.maximum(0.0, lin_output)
